...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/09/04 17:48:48 by aal-hawa          #+#    #+#             */
/*   Updated: 2024/09/04 18:23:30 by aal-hawa         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (cur.x < 0 || cur.y < 0 || cur.x >= size.x || cur.y >= size.y || tab[cur.y][cur.x] != to_flood)
		return ;
